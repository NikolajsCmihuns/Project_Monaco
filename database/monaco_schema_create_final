...
CREATE TABLE IF NOT EXISTS `monaco`.`PLACE` (
  ...
  UNIQUE INDEX `I_P_latitude_UNIQUE` (`latitude` ASC),
  UNIQUE INDEX `I_P_longitude_UNIQUE` (`longitude` ASC),
...
START TRANSACTION;
USE `monaco`;
INSERT INTO `monaco`.`COUNTRY_REF` (`COUNTRY_NAME_ID`, `COUNTRY_NAME`) VALUES (401, 'Latvia');
INSERT INTO `monaco`.`COUNTRY_REF` (`COUNTRY_NAME_ID`, `COUNTRY_NAME`) VALUES (402, 'Lithuania');
INSERT INTO `monaco`.`COUNTRY_REF` (`COUNTRY_NAME_ID`, `COUNTRY_NAME`) VALUES (403, 'Estonia');
INSERT INTO `monaco`.`COUNTRY_REF` (`COUNTRY_NAME_ID`, `COUNTRY_NAME`) VALUES (404, 'Monaco');
