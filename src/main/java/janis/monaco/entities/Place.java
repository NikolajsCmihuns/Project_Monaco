...
import janis.monaco.domain.PlacesInRoute;
import janis.monaco.domain.Review;
...
public class Place {
    ...
    private janis.monaco.domain.PlaceTypeRef placeTypeRefByPlaceTypeId;
    ...
    public janis.monaco.domain.PlaceTypeRef getPlaceTypeRefByPlaceTypeId() {
